...
const LandingPage = () => {
  return (
    <section class="relative  bg-blueGray-50">
      <button
        role="button"
        class="bg-blue-600 hover:bg-blue-700 fixed z-10 top-3  md:right-4    text-white text-sm px-4 py-2  border rounded-full"
      >
        Connect Wallet
      </button>
        ...
        <div class="container relative mx-auto">
          <div class="items-center flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                <h1 class="text-white font-semibold text-5xl">Vote Now, Vote Well.</h1>
                <p class="mt-4 text-lg text-blueGray-200 dark:text-white">This is a decentralized voting website</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="flex flex-wrap items-center md:justify-between justify-center">
              <div class="w-full md:w-6/12 px-4 mx-auto text-center">
                <div class="text-sm text-blueGray-500 font-semibold py-1">
                  Made with{" "}
                  <a href="https://www.blockgames.gg" class="text-blueGray-500 hover:text-gray-800" target="_blank">
                    teamT
                  </a>{" "}
                  by{" "}
                  <a
